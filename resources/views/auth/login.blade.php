<x-guest-layout>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px] reveal-anim">
        ...
        <div class="glass-panel overflow-hidden rounded-3xl p-8 sm:p-12 shadow-glass relative">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6 relative z-10" x-data="{ showPw: false }">
                @csrf
                ...
                <div class="space-y-2 group">
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-xs font-bold text-primary-600 hover:text-primary-500 transition-colors">
                                نسيت كلمة المرور؟
                            </a>
                        @endif
                    </div>
                ...
                <div class="flex items-center">
                    <label class="relative flex items-center cursor-pointer group">
                        ...
                        <span class="mr-3 text-sm font-bold text-surface-600 select-none group-hover:text-surface-900 transition-colors">تذكرني على هذا الجهاز</span>
                    </label>
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-surface-200 text-center text-sm font-bold text-surface-600">
                ليس لديك حساب؟ 
                <a href="{{ route('register') }}" class="text-primary-600 hover:text-primary-500 transition-colors mr-1">أنشئ حساباً جديداً</a>
            </div>
        </div>
    </div>
</x-guest-layout>
